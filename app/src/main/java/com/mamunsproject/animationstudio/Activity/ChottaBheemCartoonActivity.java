...
public class ChottaBheemCartoonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chotta_bheem_cartoon);

        RecyclerView recyclerView=findViewById(R.id.chottaBheemRecyclerView);
        ...
        DocumentReference documentReference=firebaseFirestore.
                collection("CategoryCartoon").document("chottaBheemCartoon");
    ...
    public void onBackPressed() {
        ...
        Animatoo.animateDiagonal(ChottaBheemCartoonActivity.this);
    }
