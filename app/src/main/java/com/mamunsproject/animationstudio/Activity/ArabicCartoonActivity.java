...
public class ArabicCartoonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arabic_cartoon);

        RecyclerView recyclerView=findViewById(R.id.arabicReclerView);
    ...
    public void onBackPressed() {
        ...
        Animatoo.animateDiagonal(ArabicCartoonActivity.this);
    }
}