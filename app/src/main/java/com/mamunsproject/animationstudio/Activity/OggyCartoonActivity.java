...
public class OggyCartoonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oggy_cartoon);

        RecyclerView recyclerView=findViewById(R.id.oggyCartoonReclerView);
    ...
    public void onBackPressed() {
        ...
        Animatoo.animateDiagonal(OggyCartoonActivity.this);
    }
}