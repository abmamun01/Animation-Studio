...
public class HindiCartoonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView=findViewById(R.id.hindiCartoonReclerView);
    ...
    public void onBackPressed() {
        ...
        Animatoo.animateDiagonal(HindiCartoonActivity.this);
    }
}