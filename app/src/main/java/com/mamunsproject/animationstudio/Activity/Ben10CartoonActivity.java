...
public class Ben10CartoonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ben10_cartoon);

        RecyclerView recyclerView=findViewById(R.id.ben10ReclerView);
        ...
        DocumentReference documentReference=firebaseFirestore.
                collection("CategoryCartoon").document("bnCartoon");
    ...
    public void onBackPressed() {
        ...
        Animatoo.animateDiagonal(Ben10CartoonActivity.this);
    }
}